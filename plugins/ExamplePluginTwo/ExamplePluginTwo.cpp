...
{
    static ExamplePluginTwo instance;
    return &instance;
}

void ExamplePluginTwo::LoadSettings(const wchar_t* folder)
{
    ToolboxUIPlugin::LoadSettings(folder);
    PLUGIN_LOAD_BOOL(redirect_slash_ee_to_eee);
}

void ExamplePluginTwo::SaveSettings(const wchar_t* folder)
{
...
void ExamplePluginTwo::DrawSettings()
{
    if (!toolbox_handle) {
        return;
    }
...
void ExamplePluginTwo::Initialize(ImGuiContext* ctx, const ImGuiAllocFns allocator_fns, const HMODULE toolbox_dll)
{
...
void ExamplePluginTwo::SignalTerminate()
{
...
bool ExamplePluginTwo::CanTerminate() {
    return GW::Hook::GetInHookCount() == 0;
}

void ExamplePluginTwo::Draw(IDirect3DDevice9*)
{
